...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 09 mai 2024 à 12:17
...
(1, 'test', '2024-04-25 12:00:00', 'test', 0, '#d5aeae', '#acaedc', '2024-04-25 13:00:00'),
(2, 'rdv test', '2024-04-26 09:00:00', 'test 2', 0, '#b62f2f', '#000000', '2024-04-26 11:00:00');
...
(7, 1, 3, 'test ok', '2024-05-07 22:42:54'),
(8, 1, 7, 'test', '2024-05-08 12:46:32');
...
(3, 'banni@test.fr', '[\"ROLE_USER\", \"ROLE_BANNI\"]', '$2y$13$SchWfGNCJ6SwdIAo3ySzrupKlLslZBeAOi96.NcEXVQcj3ue0w3uC', 'banni', 'test', '1919-03-01', '40 rue du bannissement', '4125221', 'villa', 605522145632, 1);
