 ...
 */
final class Version20240408110242 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categories_post (categories_id INT NOT NULL, post_id INT NOT NULL, INDEX IDX_82B9340B4B89032C (post_id), INDEX IDX_82B9340BA21214B7 (categories_id), PRIMARY KEY(categories_id, post_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
